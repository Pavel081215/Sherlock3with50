package com.startandroid.p0501_simpleadaptercustom21;
...
public class MainActivity extends Activity {
    ...
    class MyViewBinder implements SimpleAdapter.ViewBinder {
        ...
        int orange = ContextCompat.getColor(getApplicationContext(), R.color.Orange);
...
//
//        {
//            return getColor(R.color.YOURCOLOR);
//        } else        {
